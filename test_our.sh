...
"python segmentation_sample.py --data_name MMWHS --image_size 256 --model_path results/optsavedmodel015000.pt --out_dir opt15 --num_channels 128 --class_cond False --num_res_blocks 2 --num_heads 1 --learn_sigma False --use_scale_shift_norm False --attention_resolutions 16 --diffusion_steps 200 --noise_schedule linear --rescale_learned_sigmas False --rescale_timesteps False --batch_size 1"
